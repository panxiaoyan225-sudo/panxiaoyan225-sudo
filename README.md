...
* **Multi-Cloud DevOps Orchestration:** Engineered a high-availability **CI/CD** framework using **Triple-Platform Integration** ( **GitHub Actions, Azure DevOps, and GitHub Repos**). Features redundant automated 9:00 AM "heartbeat" runs and real-time Slack alerting via a self-hosted Windows agent, ensuring 100% pipeline uptime and proactive health management for production ETLs.
