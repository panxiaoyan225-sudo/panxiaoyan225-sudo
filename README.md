...
* **Multi-Cloud DevOps Orchestration:** Engineered high-availability **CI/CD automation** using **GitHub Actions, Azure DevOps, and GitHub Repos**. Features redundant automated daily "heartbeat" runs and **real-time Slack alerting** , ensuring 100% pipeline uptime and proactive health management for production ETLs.
...
---
* **Interactive Portfolio:** [View My Analytics Portfolio](https://xiaoyan-pan-data-analytics-portfolio-170069322954.us-west1.run.app/)                            
