...
* **Multi-Cloud DevOps Orchestration:** Engineered high-availability **CI/CD automation** using **Azure DevOps, GitHub Actions, and Cloud Run**. Features redundant automated hourly "heartbeat" runs and **real-time Slack alerting** , ensuring 100% pipeline uptime and proactive health management for production ETLs.
